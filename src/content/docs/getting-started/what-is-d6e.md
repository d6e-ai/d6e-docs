...
- [アーキテクチャ](/getting-started/architecture/) — 信頼境界と構成図
- [設計思想](/getting-started/design-philosophy/) — 疎結合の原則
- [開発パスの選び方](/getting-started/choosing-a-path/) — コンソール / Plugin / Docker STF / カスタム FE
- [ローカル AI 開発](/guides/local-ai-development/) — MCP 接続の最短手順
