...
公開 API の入口はインスタンスの `/api/v1/*` です。詳細なエンドポイント一覧は [REST API](/reference/rest-api/) を参照してください。
...
Docker STF の作り方は [Docker STF 開発](/guides/docker-stf/) を参照してください。
...
認証の流れの全体像は [アーキテクチャ](/getting-started/architecture/) を参照してください。
...
- [MCP ツール](/reference/mcp-tools/)
- [アーキテクチャ](/getting-started/architecture/)
- [設計思想](/getting-started/design-philosophy/)
- [Docker STF 開発](/guides/docker-stf/)
- [カスタムフロントエンド](/guides/custom-frontend/)
- [ローカル AI 開発](/guides/local-ai-development/)
