...
接続手順・環境変数・トラブルシュートは [ローカル AI 開発](/ja-jp/guides/local-ai-development/) を参照してください。
...
- [ローカル AI 開発](/ja-jp/guides/local-ai-development/) — MCP 接続手順
- [REST API](/ja-jp/reference/rest-api/) — 同等の HTTP エンドポイント
