...
The public API surface is `/api/v1/*` on the instance. See [REST API](/en/reference/rest-api/) for the full catalog.
...
See [Docker STF development](/en/guides/docker-stf/) for container contracts.
...
For the broader auth flow, see [Architecture](/en/getting-started/architecture/).
...
- [REST API](/en/reference/rest-api/)
- [MCP tools](/en/reference/mcp-tools/)
- [Architecture](/en/getting-started/architecture/)
- [Design philosophy](/en/getting-started/design-philosophy/)
- [Docker STF development](/en/guides/docker-stf/)
- [Custom frontend](/en/guides/custom-frontend/)
- [Local AI development](/en/guides/local-ai-development/)
