...
5. Optionally bundle into a [Plugin](/en/guides/plugins/) `template.yaml`
...
For registration, instant-run, and describe, see [REST API](/en/reference/rest-api/#stfs) and [MCP](/en/reference/mcp-tools/#stfs--libraries).
