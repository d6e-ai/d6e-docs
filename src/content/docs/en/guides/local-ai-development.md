...
See [MCP tools](/en/reference/mcp-tools/) for the full catalog.
...
- **Custom frontend:** an independent web app — see [Custom frontend](/en/guides/custom-frontend/) and [frontend-and-instance.md](https://github.com/d6e-ai/d6e-custom-frontend-skills/blob/main/docs/frontend-and-instance.md)

## Next steps

- [Plugin development](/en/guides/plugins/)
