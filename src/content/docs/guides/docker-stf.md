...
5. 必要なら [Plugin](/guides/plugins/) の `template.yaml` に含めて配布
...
API 側の登録・instant-run・describe は [REST API](/reference/rest-api/#stfs) と [MCP](/reference/mcp-tools/#stfs--libraries) を参照してください。
