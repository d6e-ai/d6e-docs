...
For connection steps, environment variables, and troubleshooting, see [Local AI development](/en-us/guides/local-ai-development/).
...
- [Local AI development](/en-us/guides/local-ai-development/) — MCP connection guide
- [REST API](/en-us/reference/rest-api/) — equivalent HTTP endpoints
