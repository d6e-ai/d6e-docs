...
They extend opposite sides of the same API boundary and combine naturally. See [Custom frontend](/en-us/guides/custom-frontend/) and [Plugin development](/en-us/guides/plugins/).
