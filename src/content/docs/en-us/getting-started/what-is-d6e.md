...
- [Architecture](/en-us/getting-started/architecture/) — trust boundaries and diagrams
- [Design philosophy](/en-us/getting-started/design-philosophy/) — loose-coupling principles
- [Choosing a path](/en-us/getting-started/choosing-a-path/) — console / Plugin / Docker STF / custom FE
- [Local AI development](/en-us/guides/local-ai-development/) — shortest MCP setup
